package com.instrument.essearch.service;
...
public interface BaseSearchService<T> {
    ...
    ResultJsonContent<List<SearchResult>> queryHitByPage1(int pageNo, int pageSize, String keyword, String indexName, String ... fieldNames);
